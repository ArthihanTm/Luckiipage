    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(userEmail)
                ...
                // If the user no longer exists (e.g., DB reset with ddl-auto=create-drop),
                // treat request as anonymous instead of failing the whole request.
            ...
            // Any JWT parsing/validation issue should not crash the request with 500.
